...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "kesarinandankumar2001@gmail.com",
    href: "mailto:kesarinandankumar2001@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/kesari-nandan-897156220/",
    content: "/naresh-khatri",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/CKNKP",
    content: "/naresh-khatri",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Kesari Nandan</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Kesari, a Fullstack developer passionate about
